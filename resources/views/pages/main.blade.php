            ...
            <div class="col fill_height">
                ...
                <div class="search_tabs_container">
                    <div class="search_tabs d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
                        <div class="search_tab active d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><i class="fas fa-plane"></i><br>{{ __('text.text_a2') }}</span></div>
                        <div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><i class="fas fa-hotel fnt40" aria-hidden="true"></i><br>{{ __('text.text_a3') }}</div>
                        <div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><i class="fas fa-map-marked-alt fnt40" aria-hidden="true"></i><br>{{ __('text.text_a4') }}</div>
                        <div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><i class="fas fa-train fnt40" aria-hidden="true"></i><br>{{ __('text.text_a5') }}</div>
                        <div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><i class="fas fa-address-card"></i><br>{{ __('text.text_a6') }}</div>
                        <div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><i class="fas fa-redo fnt40" aria-hidden="true"></i><br>{{ __('text.text_a7') }}</div>
...
" height="488" frameborder="0" scrolling="no" class="two_hidden"> </iframe>
                ...
                <div class="search_panel" style=" justify-content: center;">
                    <div class="button home_slider_button" style="    z-index: 99;">
                        <div class="button_bcg"></div><a href="https://experience.tripster.ru/?exp_partner=8top&utm_source=8top&utm_campaign=affiliates&utm_medium=link">{{ __('text.text_a15') }}</a>
                    </div>
                </div>
                <!-- Круизы -->
                <div class="search_panel" style=" justify-content: center;">
...
<div class="container">
    <div class="row">
        <div class="col col-lg-12 col-md-12 col-sm-12">
            <p class="p_text_part">{{ __('text.text_a12') }}</p>
            <p class="p_text_down_part">{{ __('text.text_a13') }}</p>
        </div>
    </div>
